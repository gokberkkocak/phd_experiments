...
if __name__ == '__main__':
    ...
    pickled_automl_file = "models/" + threshold + "_pickled_013" + "/" + config + "_with_test_" + train_index + "_" + \
        str(int(rnd_seed))+"_finalf.pkl"

    print("using pickled clf from: {}".format(pickled_automl_file))
